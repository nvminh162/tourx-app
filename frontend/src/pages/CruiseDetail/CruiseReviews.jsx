...
const CruiseReviews = () => {
    ...
    const reviews = [
        ...
        },
        {
            ...
            rating: 5,
            comment:
                "Thật nghiệm tuyệt vời và dịch vụ tuyệt vọng quan tâm đến. Tàu đẹp, nhân viên chuyên nghiệp, đồ ăn ngon.",
            date: "01/02/2025",
        },
        {
            id: 4,
            ...
            rating: 5,
            comment:
                "Kinh nghiệm du thuyền rất tốt! Ngắm nhìn vịnh Hạ Long rất tuyệt vời và thức ăn trên tàu rất ngon. Tàu sạch, các cabin được trang bị đầy đủ. Đặc biệt là bể bơi trên tàu thật tuyệt vời. Tôi rất hài lòng với nghỉ dưỡng đã ở trên tàu với gia đình. Chúng tôi đã có một kỳ nghỉ tuyệt vời và sẽ quay lại Halong Bay và đi du thuyền Heritage Bình Chuẩn Cát Bà một lần nữa trong tương lai gần! Tôi cảm ơn tất cả nhân viên.",
            date: "01/02/2025",
        },
        {
            id: 5,
            ...
            rating: 5,
            comment:
                "Du thuyền đẹp, phong cảnh vịnh Hạ Long gần như hoàn hảo. Tôi sẽm nhất trí cho mọi người rằng nên đi du thuyền này một lần.",
            date: "01/02/2025",
        },
    ]
                ...
                <div className="flex items-center gap-1">
                    ...
                    {[1, 2, 3].map((page) => (
                        <button
                            ...
                            className={`w-8 h-8 rounded-md flex items-center justify-center ${currentPage === page ? "bg-teal-500 text-white" : "text-gray-600 hover:bg-gray-100"
                                }`}
                        >
                            {page}
                        </button>
