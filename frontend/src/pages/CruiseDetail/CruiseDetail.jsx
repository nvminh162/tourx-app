...
import { getAllCruises, getCruiseById, saveCruiseBooking } from '../../services/cruiseService';
...
const CruiseDetail = () => {
    ...
    const handleBookingSubmit = async (e) => {
        ...
        if (!isLoggedIn()) {
            ...
            setBookingErrors({ 
                submit: 'Bạn cần đăng nhập để đặt du thuyền. Đang chuyển hướng đến trang đăng nhập...' 
            });
            ...
            setTimeout(() => {
                ...
                navigate(config.routes.auth, { 
                    state: { 
                        from: `/cruise/${cruiseSlug}`,
                        message: 'Vui lòng đăng nhập để tiếp tục đặt du thuyền.' 
                    } 
                });
            }, 2000);
        ...
        try {
            ...
            await saveCruiseBooking(bookingDBData);
            ...
            console.error('Lỗi khi xử lý đặt tàu:', error);
    ...
    return (
        <div className="space-y-20 py-20">
                ...
                <div className="flex flex-col lg:flex-row gap-10 justify-between items-start mb-6 pb-20 container lg:w-6xl px-5 lg:px-0 mx-auto">
                    <div>
                        ...
                        <div className="flex flex-wrap items-center gap-2 mt-3">
                            ...
                            <button
                                onClick={() => scrollToSection('cruise-map')}
                    ...
                    <div className="mt-4 md:mt-0">
                        <div className="text-teal-700 text-2xl md:text-3xl font-bold text-right">
                            {price.toLocaleString('vi-VN')} đ/khách
                        </div>
                        <button
            ...
            <SectionHeader
                ...
                description="Du thuyền xuất phát từ Cảng tàu khách quốc tế Hạ Long, Quảng Ninh"
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            {bookingErrors.bookingDate && (
                                                <p className="text-red-500 text-xs mt-1">{bookingErrors.bookingDate}</p>
                                            )}
                                        </div>
