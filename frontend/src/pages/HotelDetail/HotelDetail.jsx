...
const HotelDetail = () => {
  ...
  const handleBookingSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Lỗi khi gửi email đặt phòng:', error);
                  ...
                  <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={handleBookingSubmit}>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="flex w-full items-center rounded-lg bg-white border border-gray-300 shadow-sm focus-within:ring-2 focus-within:ring-teal-400 transition-all">
                        ...
                        >
                          <option value="standard">Phòng Standard - {price.toLocaleString("vi-VN")}đ/đêm</option>
                          <option value="deluxe">Phòng Deluxe - {(price * 1.5).toLocaleString("vi-VN")}đ/đêm</option>
                          <option value="suite">Phòng Suite - {(price * 2).toLocaleString("vi-VN")}đ/đêm</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      {bookingErrors.checkInDate && <p className="text-red-500 text-xs mt-1">{bookingErrors.checkInDate}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      {bookingErrors.checkOutDate && <p className="text-red-500 text-xs mt-1">{bookingErrors.checkOutDate}</p>}
                    </div>
                      ...
                      <div className="md:col-span-2 bg-gray-50 p-3 rounded-lg">
                        ...
                        <div className="flex justify-between items-center mt-1">
                          ...
                          <span className="font-bold text-teal-700">
                            {(calculateStayDuration() * getRoomPrice()).toLocaleString("vi-VN")} đ
                          </span>
                        </div>
                      </div>
                    )}
