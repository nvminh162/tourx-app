      ...
      <div className="h-[96px] w-full drop-shadow-sm bg-white fixed top-0 z-50">
        ...
        >
          ...
          <div className="relative flex items-center justify-center mx-5">
            <Button className="text-2xl rounded-full cursor-pointer h-13 w-13 focus:text-primary-base" onClick={handleOpenSearch}>
              <FontAwesomeIcon icon={faMagnifyingGlass} beat />
            </Button>

            {/* <Button className="text-2xl rounded-full cursor-pointer h-13 w-13 focus:text-primary-base">
          ...
          <div
            className={`shadow-2xl border-t-1 border-t-gray-300 absolute gap-3 xl:hidden top-24 left-0 w-full bg-white flex flex-col items-center font-semibold text-lg transform transition-transform ${isMenuOpen ? "opacity-100 visible pointer-events-auto" : "opacity-0 invisible pointer-events-none"
              }`}
